...
\subsection{Codice}
\lstinputlisting[label=config, caption=config.c, style=customc]{progetto_so/procScheduler/config.h}
\lstinputlisting[label=task, caption=Task Manager, style=customc]{progetto_so/procScheduler/taskmanager.h}
\lstinputlisting[label = sched, caption=scheduler.c, style=customc]{progetto_so/procScheduler/scheduler.c}
...
\subsection{Codice}
\lstinputlisting[label=cmd, caption=cmd.c, style=customc]{progetto_so/commandexe/cmd.c}
\lstinputlisting[label=funct, caption=functions.h, style=customc]{progetto_so/commandexe/functions.h}
...
Qu\'i andranno gli screenshot
\subsection{Codice}
\lstinputlisting[label=config3, caption=config.h, style=customc]{progetto_so/messageExchange/config.h}
\lstinputlisting[label=funcli, caption=functions.client.h, style=customc]{progetto_so/messageExchange/functions.client.h}
\lstinputlisting[label=funser, caption=functions.server.h, style=customc]{progetto_so/messageExchange/functions.server.h}
\lstinputlisting[label=list, caption=listmanage.h, style=customc]{progetto_so/messageExchange/listmanage.h}
\lstinputlisting[label=funinc, caption=functions.inc.h, style=customc]{progetto_so/messageExchange/functions.inc.h}
\lstinputlisting[label=client, caption=client.c, style=customc]{progetto_so/messageExchange/client.c}
\lstinputlisting[label=server, caption=server.c, style=customc]{progetto_so/messageExchange/server.c}
